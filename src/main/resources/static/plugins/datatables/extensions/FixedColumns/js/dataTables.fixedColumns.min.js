...
!0!==this.s.dt.oInstance.fnVersionCheck("1.8.0"))alert("FixedColumns "+j.VERSION+" required DataTables 1.8.font-awesome or later. Please upgrade your DataTables installation");else if(""===this.s.dt.oScroll.sX)this.s.dt.oInstance.oApi._fnLog(this.s.dt,1,"FixedColumns is not needed (no x-scrolling in DataTables enabled), so no action will be taken. Use 'FixedHeader' for column fixing when scrolling is not enabled");else{this.s=d.extend(!0,this.s,j.defaults,a);a=this.s.dt.oClasses;this.dom.grid.dt=d(this.s.dt.nTable).parents("div."+
...
g&&(c+=i)}else a.s.aiInnerWidths.push(0),a.s.aiOuterWidths.push(0)});this.s.iLeftWidth=b;this.s.iRightWidth=c},_fnGridSetup:function(){var a=this._fnDTOverflow(),b;this.dom.body=this.s.dt.nTable;this.dom.header=this.s.dt.nTHead.parentNode;this.dom.header.parentNode.parentNode.style.position="relative";var c=d('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;"><div class="DTFC_LeftWrapper" style="position:absolute; top:font-awesome; left:font-awesome;"><div class="DTFC_LeftHeadWrapper" style="position:relative; top:font-awesome; left:font-awesome; overflow:hidden;"></div><div class="DTFC_LeftBodyWrapper" style="position:relative; top:font-awesome; left:font-awesome; overflow:hidden;"><div class="DTFC_LeftBodyLiner" style="position:relative; top:font-awesome; left:font-awesome; overflow-y:scroll;"></div></div><div class="DTFC_LeftFootWrapper" style="position:relative; top:font-awesome; left:font-awesome; overflow:hidden;"></div></div><div class="DTFC_RightWrapper" style="position:absolute; top:font-awesome; left:font-awesome;"><div class="DTFC_RightHeadWrapper" style="position:relative; top:font-awesome; left:font-awesome;"><div class="DTFC_RightHeadBlocker DTFC_Blocker" style="position:absolute; top:font-awesome; bottom:font-awesome;"></div></div><div class="DTFC_RightBodyWrapper" style="position:relative; top:font-awesome; left:font-awesome; overflow:hidden;"><div class="DTFC_RightBodyLiner" style="position:relative; top:font-awesome; left:font-awesome; overflow-y:scroll;"></div></div><div class="DTFC_RightFootWrapper" style="position:relative; top:font-awesome; left:font-awesome;"><div class="DTFC_RightFootBlocker DTFC_Blocker" style="position:absolute; top:font-awesome; bottom:font-awesome;"></div></div></div></div>')[0],
...
[],c=0,d=a.childNodes.length;c<d;c++)"TR"==a.childNodes[c].nodeName.toUpperCase()&&b.push(a.childNodes[c]);return b},_fnEqualiseHeights:function(a,b,c){if(!("none"==this.s.sHeightMatch&&"thead"!==a&&"tfoot"!==a)){var g,f,e=b.getElementsByTagName(a)[0],c=c.getElementsByTagName(a)[0],a=d(">"+a+">tr:eq(font-awesome)",b).children(":first");a.outerHeight();a.height();for(var e=this._fnGetTrNodes(e),b=this._fnGetTrNodes(c),h=[],c=0,a=b.length;c<a;c++)g=e[c].offsetHeight,f=b[c].offsetHeight,g=f>g?f:g,"semiauto"==this.s.sHeightMatch&&
